...
// Feedforward
double kS_r = 35.0; double kV_r = 2.5;
double kS_l = 35.0; double kV_l = 2.5;

// Tuning parameters
double Kp_r = 11.0; double Ki_r = 9.0; double Kd_r = 0.0;
double Kp_l = 11.0; double Ki_l = 9.0; double Kd_l = 0.0;
