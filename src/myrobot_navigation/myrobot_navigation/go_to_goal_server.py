    ...
    def _execute(self, goal_handle):
        ...
        while rclpy.ok():
            ...
            if state is _State.ALIGN:
                ...
                if abs(heading_err) < self._align_tol and abs(self._yaw_rate) < self._ang_vel_thresh:
                    state = _State.DRIVE
                ...
                if abs(final_yaw_err) < self._orient_tol and abs(self._yaw_rate) < self._ang_vel_thresh:
                    break  # success
